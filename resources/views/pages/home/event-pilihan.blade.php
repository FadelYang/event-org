<div id="eventPilihan">
    <div class="section-header my-2 md:my-10 block md:flex items-center">
        ...
        <div class="flex gap-3 md:gap-4 me-10 mt-1 md:mt-0">
            <button id="buttonLeftEventPilihan" class="h-8 w-8 md:h-10 md:w-10 bg-gray-600 text-white rounded-full font-bold text-xl md:text-3xl"><</button>
            <button id="buttonRightEventPilihan" class="h-8 w-8 md:h-10 md:w-10 bg-gray-600 text-white rounded-full font-bold text-xl md:text-3xl">></button>
        </div>
    </div>
