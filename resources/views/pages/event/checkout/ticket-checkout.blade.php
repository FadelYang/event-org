        ...
        <div class="mt-5">
            <form action="" method="post">
                ...
                <div>
                    ...
                    <textarea id="customer_address" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="text" name="customer_address"
                ...
                <button type="submit" class="py-2 px-5 border-2 border-black rounded text-lg md:text-xl text-gray-200 bg-gray-800 mt-4">Checkout</button>
            </form>
        </div>
    </div>
