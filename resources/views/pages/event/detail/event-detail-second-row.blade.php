<div class="block xl:flex gap-3 mt-3">
    <div class="w-full max-h-[374px] px-2 sm:px-0 max-w-[811px] xl:min-h-[200px] xl:min-w-[811px] rounded-lg">
        <p class="text-2xl md:text-4xl font-bold mb-5">Deskripsi</p>
        <p class="text-md lg:text-lg">{{ $event->description }}</p>
    </div>
    <div class="w-full max-w-[811px] mt-3 xl:mt-0 block sm:flex px-2 sm:px-0">
